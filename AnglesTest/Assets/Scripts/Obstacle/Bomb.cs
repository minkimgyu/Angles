...
//    public BombData(UpgradeableStat<float> maxHp, float damage, float attackRange, float groggyDuration) : base(maxHp, ITarget.Type.Construction, BaseEffect.Name.TriangleDestroyEffect)
//    {
//        _damage = damage;
