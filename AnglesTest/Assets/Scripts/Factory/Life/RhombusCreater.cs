...
public class RhombusData : EnemyData
{
    ...
    public RhombusData(UpgradeableStat<float> maxHp, ITarget.Type targetType, BaseEffect.Name dieEffectName, BaseLife.Size size, Dictionary<BaseSkill.Name, int> skillDataToAdd,
...
public class RhombusCreater : LifeCreater
{
    ...
    public RhombusCreater(BaseLife lifePrefab, LifeData lifeData, DropData dropData, BaseFactory SpawnEffect,
